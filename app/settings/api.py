...
def init_app(app: Flask):
    ...
    api.add_resource(Polls, "/polls", endpoint="/polls", methods=["POST"])
    ...
    api.add_resource(Events, "/events/<int:event_id>", endpoint="/events/<int:event_id>", methods=['PATCH', 'DELETE', 'GET'])
